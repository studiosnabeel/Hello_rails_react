...
```sh
  cd my-folder
  https://github.com/Alabi12/Hello_Rails_App.git
```
...
```sh
  ...
  sudo gem webpack rails
  sudo gem react rails
...
Feel free to check the [issues page](https://github.com/studiosnabeel/Hello_rails_react/issues).
...
This project is [MIT](https://github.com/Alabi12/Hello_Rails_App/new/dev/LICENSE) licensed.
